    ...
    return (
            <>
                <PageIntro
                        ...
                        title="Privacy Policy for Ape Dev GmbH"
                >

                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <p>At Ape Dev, accessible from ape-dev.de, one of our main priorities is the privacy of our
                            visitors. This Privacy Policy document contains types of information that is collected and
                            recorded by Ape Dev and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Ape Dev. This
                            policy
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Consent</h2>
                        <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
                    </div>

                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Information we collect</h2>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">How we use your information</h2>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Log Files</h2>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Advertising Partners Privacy
                            Policies</h2>
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons
                            that are used in their respective advertisements and links that appear on Ape Dev, which are
                            sent directly to users&apos; browser. They automatically receive your IP address when this
                            occurs.
                        ...
                        <p>Note that Ape Dev has no access to or control over these cookies that are used by third-party
                            advertisers.</p>
                    </div>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">CCPA Privacy Rights (Do Not Sell
                            My
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">GDPR Data Protection Rights</h2>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Children&apos;s Information</h2>

                        <p>Another part of our priority is adding protection for children while using the internet. We
                            encourage parents and guardians to observe, participate in, and/or monitor and guide their
                            online activity.</p>

                        <p>Ape Dev does not knowingly collect any Personal Identifiable Information from children under
                            the
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Changes to This Privacy
                            Policy</h2>
                    ...
                    <div className="border-b border-gray-200 pb-5 mb-6">
                        <h2 className="text-base font-semibold leading-6 text-gray-900">Contact Us</h2>
