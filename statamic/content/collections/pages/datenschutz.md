...
seo_description: 'Datenschutzerklärung der Ape Dev GmbH. DSGVO-konform, transparent, ohne Tracking.'
---
...
Bei Fragen zu dieser Datenschutzerklärung kontaktieren Sie uns gerne per E-Mail an {{ 'info@ape-dev.de' | obfuscator }} oder über das [Kontaktformular](/kontakt).
...
- E-Mail: {{ 'info@ape-dev.de' | obfuscator }}
...
Anfragen zum Datenschutz richten Sie bitte an {{ 'info@ape-dev.de' | obfuscator }}.
...
Widerspruch jederzeit möglich per E-Mail an {{ 'info@ape-dev.de' | obfuscator }}.
...
Wenn Sie sich direkt per E-Mail an {{ 'info@ape-dev.de' | obfuscator }} oder eine andere Adresse unter ape-dev.de wenden (also nicht über das Kontaktformular), wird Ihre Nachricht in unserem Microsoft-365-Postfach gespeichert.
...
Anfragen senden Sie bitte an {{ 'info@ape-dev.de' | obfuscator }}.

**Beschwerderecht (Art. 13 Abs. 2 lit. d DSGVO):** Sie haben das Recht, sich bei einer Aufsichtsbehörde zu beschweren — für uns ist das die **Landesbeauftragte für den Datenschutz Niedersachsen**, Prinzenstraße 5, 30159 Hannover, [https://lfd.niedersachsen.de](https://lfd.niedersachsen.de).
...
Stand dieser Datenschutzerklärung: Mai 2026. Die jeweils aktuelle Fassung ist unter [/datenschutz](/datenschutz) abrufbar.
